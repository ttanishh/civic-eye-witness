...
import { Shield, User, Phone, Mail, ArrowRight, AlertTriangle } from 'lucide-react';
...
export default function SignupPage() {
  ...
  const handleOtpSubmit = async (e) => {
    ...
    try {
      // Mock API call - in a real app, this would verify the OTP and create account
      await new Promise(resolve => setTimeout(resolve, 1000));
    ...
    <div className="max-w-md w-full mx-auto">
      <div className="bg-white p-8 rounded-lg shadow-md border border-gray-100">
        <div className="text-center mb-6">
          ...
          <p className="text-gray-600 mt-1">Join KAVACH secure reporting platform</p>
        </div>
